<?php
     ...
     * @copyright 2022
     * @version $Id: login.tpl.php, v1.00 2022-03-05 10:12:05 gewa Exp $
     */
    if (!defined("_WOJO"))
  ...
  <div id="formContent">
    ...
    <div id="loginform">
      <form id="admin_form" name="admin_form" method="post">
        ...
        <input type="password" class="fadeIn third" name="password" placeholder="<?php echo Lang::$word->PASSWORD; ?>">
        <button id="doSubmit" type="button" name="submit"
          class="fadeIn fourth"><?php echo Lang::$word->LOGIN; ?></button>
      </form>
    ...
    <div id="passform" class="hide-all">
      <input type="text" name="pEmail" id="pEmail" class="input-container"
        placeholder="<?php echo Lang::$word->EMAIL; ?>">
