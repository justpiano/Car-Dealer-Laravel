<?php
     ...
     * @copyright 2022
     * @version $Id: system.tpl.php, v1.00 2022-04-05 10:12:05 gewa Exp $
     */
    if (!defined("_WOJO"))
...
<div class="wojo tabs">
  <ul class="nav">
    ...
    <li><a data-tab="dbtables" class="last"><i class="icon server"></i>
            <?php echo Lang::$word->SYS_DBTABLE_INF; ?></a>
    </li>
  </ul>
  <div class="wojo segment tab">
    <div data-tab="cms" class="item">
      <table class="wojo basic repsonsive table">
        <thead>
        <tr>
    ...
    <div data-tab="server" class="item">
      <table class="wojo basic repsonsive table">
        ...
        <tr>
          ...
          <td><?php echo Db::Go()->getAttribute(PDO::ATTR_CLIENT_VERSION); ?></td>
        </tr>
        <tr>
          <td><?php echo Lang::$word->SYS_DBV; ?>:</td>
          <td><?php echo Db::Go()->getAttribute(PDO::ATTR_SERVER_VERSION); ?></td>
        </tr>
        <tr>
