<form action="setup.php?step=2" method="post">
  <div id="inner">
    ...
    <main>
      ...
      <p class="info">Setting up Cms Pro to run on your server involves 3 simple steps. Please enter the hostname of the server Car Dealer Pro is to be installed on. Enter the MySQL username, password and database name you wish to use with Car Dealer Pro. </p>
      ...
      <p class="info">Configure correct paths and URLs to your Car Dealer Pro.</p>
      <table class="data forms">
        <tr>
  ...
  <footer class="clearfix"> <small>current <b>car delaer pro v3.0</b></small>
    <div id="buttons">
