<?php
     ...
     * @copyright 2022
     * @version $Id: message.class.php, v1.00 2022-03-20 18:20:24 gewa Exp $
     */
    ...
    class Message
    {
         ...
         * @return string|void
         */
        public static function msgAlert($msg, $print = true)
        {
            self::$showMsg = "<div class=\"wojo icon message alert\"><i class=\"icon exclamation triangle\"></i><i class=\"icon x alt\"></i>";
        ...
        {
            self::$showMsg = "<div class=\"wojo alert small icon message\"><i class=\"icon exclamation triangle\"></i> <div class=\"content\">" . $msg . "</div></div>";
         ...
         * @return string|void
         */
        public static function msgOk($msg, $print = true)
        {
            self::$showMsg = "<div class=\"wojo icon message positive\"><i class=\"circle check icon\"></i><i class=\"icon x alt\"></i>";
        ...
        {
            self::$showMsg = "<div class=\"wojo positive small icon message\"><i class=\"circle check icon\"></i> <div class=\"content\">" . $msg . "</div></div>";
         ...
         * @return string|void
         */
        public static function msgInfo($msg, $print = true)
        {
            self::$showMsg = "<div class=\"wojo icon message info\"><i class=\"icon info circle\"></i><i class=\"icon x alt\"></i>";
        ...
        {
            self::$showMsg = "<div class=\"wojo info small icon message\"><i class=\"icon info circle\"></i> <div class=\"content\">" . $msg . "</div></div>";
         ...
         * @return string|void
         */
        public static function msgError($msg, $print = true)
        {
            self::$showMsg = "<div class=\"wojo icon message negative\"><i class=\"icon dash circle\"></i><i class=\"icon x alt\"></i>";
        ...
        {
            self::$showMsg = "<div class=\"wojo negative icon small message\"><i class=\"icon dash circle\"></i> <div class=\"content\">" . $msg . "</div></div>";
        ...
        {
            self::$showMsg = "<div class=\"wojo negative message\"><i class=\"icon x alt\"></i><div class=\"header\">" . Lang::$word->PROCCESS_ERR . "</div><div class=\"content\"><ul class=\"wojo list\">";
        ...
        {
            self::$showMsg = "<div class=\"wojo small list\">";
            $i = 1;
            foreach (self::$msgs as $msg) {
                self::$showMsg .= "<div class=\"item align middle\"><b>" . $i . ".</b> " . $msg . "</div>\n";
                $i++;
            }
            self::$showMsg .= "</div>";
        ...
        public static function msgReply($data, $type, $msg, $msg2 = false)
        {
            ...
            if ($data) {
                ...
                $json['message'] = ($msg2) ?: Lang::$word->NOPROCCESS;
            }
         ...
         * @return void
         */
        public static function msgModalReply($data, $type, $msg, $html)
        {
            $title = strtoupper($type);
            if ($data) {
                $json['type'] = $type;
         ...
         * @return void
         */
        #[NoReturn] public static function error($msg, $source)
        {
            if (DEBUG) {
        ...
        {
            self::$showMsg = "<div class=\"wojo negative message\"><i class=\"icon slash circle\"></i> " . Lang::$word->SYSTEM_ERR1 . " <em>$data</em></div>";
        ...
        {
            self::$showMsg = "<div class=\"wojo negative message\"><i class=\"icon slash circle\"></i> " . Lang::$word->SYSTEM_ERR2 . " <em>$data</em></div>";
         ...
         * @return void
         */
        #[NoReturn] public static function ooops()
        {
