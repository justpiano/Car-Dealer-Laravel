...
(function() {
    ...
    $R.add('service', 'inline', {
        ...
        getInlines: function(tags) {
            return (tags) ? this.selection.getInlines({
                tags: tags,
                all: true
    ...
    $R.add('service', 'utils', {
        ...
        getElementsFromHtml: function(html, selector, exclude) {
            ...
            return mapping.call(elems, function(el) {
                ...
                if (exclude && type && type === exclude) {} else return el.outerHTML;
            });
        },
    ...
    $R.add('module', 'editor', {
        ...
        _buildOptions: function() {
            ...
            if (this.opts.maxWidth) $editor.css({
        ...
        _disableReadOnly: function() {
            ...
            this._getEditables($editor).attr({
                'contenteditable': true
            });
    ...
    $R.add('module', 'link', {
        ...
        _getLinks: function() {
            var links = this.selection.getInlines({
                all: true,
                tags: ['a']
            });
            var arr = [];
    ...
    $R.add('module', 'image', {
        ...
        _save: function($modal, $form) {
            ...
            if (this.opts.imageLink) imageData.link = {
                url: data.url,
                target: data.target
            };
    ...
    $R.add('module', 'list', {
        ...
        _unformat: function(type, nodes) {
            if (nodes.length === 1) {
                ...
                var selectedItems = this.selection.getNodes({
                    tags: ['li']
                });
                var block = this.selection.getBlock();
