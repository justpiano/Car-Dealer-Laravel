<?php
   ...
   * @copyright 2022
   * @version $Id: print_pdf.tpl.php, v1.00 2022-10-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<table border="0" class="divider">
  <tr>
    <td style="width: 60%;" valign="top" class="none"><?php if (file_exists(UPLOADS . 'print_logo.png')):?>
      ...
      <?php endif;?></td>
    <td valign="top"  class="none" style="width:40%;text-align: right"><h4 style="margin:0px;padding:0px;font-size: 12px;">Invoice: # <?php echo $this->row->invid . '-' . $this->row->id;?> </h4>
...
<table style="padding-top:25px">
  ...
  <tr>
    <td valign="top" style="width:60%"><p><b> <?php echo $this->core->company;?></b><br />
    ...
    <td colspan="2" valign="top" style="width:40%"><p> <?php echo $this->row->fullname;?>
...
<table class="inventory">
  ...
  <tbody>
    <tr>
      ...
      <td class="right"><span><?php echo $this->row->total;?></span></td>
    </tr>
    <tr>
